...
import { deleteItemOffline, type ItemTab } from "@/lib/offline/sync";
...
// Duplicar não vive mais aqui (2026-09-08): virou "abrir a tela de detalhe como item NOVO
// pré-preenchido, criar só no Salvar" - ver `duplicateFromId` em DetailScreen e o handler em
// MainApp. Não grava nada na planilha antes de o usuário confirmar.
